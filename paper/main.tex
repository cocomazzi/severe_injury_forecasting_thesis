...
\vspace{1em}
\hspace{2em}\textit{SQ2.1: How does introducing an exogenous variable, namely the industry code, affect the forecasts of the ML models?}


\vspace{1em}

To answer this question, we will explore feature importances.

\vspace{1em}
\hspace{2em}\textbf{RQ3:}\textit{CV for sensitivity analysis}
